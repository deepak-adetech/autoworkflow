...
function ToolPill({ name, icon, color }: { name: string; icon: React.ReactNode; color: string }) {
  return (
    ...
    >
      <span className="text-[#55585E] group-hover/pill:text-current transition-colors duration-200" style={{ color: undefined } as React.CSSProperties}
  ...
  return (
    <section id="tools" className="py-16 md:py-20 relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-5 sm:px-8 mb-10">
        ...
        >
          <p className="text-xs font-medium text-[#5E6AD2] tracking-widest uppercase mb-3">
            Integrations
          </p>
          ...
          <p className="text-[#8A8F98] text-base leading-relaxed max-w-xl mx-auto">
      ...
      <div className="relative mb-4">
        <div className="absolute left-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-r from-[#09090B] to-transparent" />
        <div className="absolute right-0 top-0 bottom-0 w-20 z-10 bg-gradient-to-l from-[#09090B] to-transparent" />
